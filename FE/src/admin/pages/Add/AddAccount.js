...
const AddAccount = () => {
  ...
  // Khi submit form, tạo FormData và gửi qua axios
  const onSubmit = async (data) => {
    const formData = new FormData();
    // Đảm bảo gửi đủ các trường cần thiết
    ...
    try {
      const response = await axios.post("http://localhost:8080/api/accounts", formData, {
      ...
      // Nếu backend trả về lỗi liên quan đến trùng lặp username hoặc email, setError cho input tương ứng
      const errMsg = error.response?.data || "Có lỗi xảy ra khi tạo tài khoản.";
  ...
  return (
    <div className="container mt-5">
      <h2 className="mb-4">Thêm Tài khoản</h2>
